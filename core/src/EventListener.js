...
// Blockchain.tokenContract should be implemented
export function listenForTransfers(cb) {
  // TODO connect to blockchain in future
  // let contract = Blockchain.tokenContract();
  // console.log(`Contract: ${contract}`);
  
  // let transferFilter = contract.filters.Transfer(); // TODO alex update event

  // contract.on(transferFilter, (whatever) => {
  //     cb(whatever);
  // })
  ...
  function event() {
    ...
    cb({
      amount: counter * 10,
      from: '0x' + counter * 123123123123,
      to: '0x' + counter * 12312343434123132132,
    })
  }
